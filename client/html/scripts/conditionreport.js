let app = document.getElementById("conditionreport");
const baseUrl = "https://localhost:7258/api/books";

function conditionReportOnLoad() {
    let table = createConditionTable()
...
function createConditionTable()
{
        ...
        th2.width = 325;
        th2.appendChild(document.createTextNode("CONDITION OF BOOK"));
        tr.appendChild(th2);
